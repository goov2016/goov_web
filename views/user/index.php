...
echo <<<END
<!DOCTYPE html>
<!-- saved from url=(0025)https://mp.weixin.qq.com/ -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <link onerror="wx_loaderror(this)" rel="stylesheet" href="../../css/page_login26f6ea.css">
        <script type="text/javascript">  
            points[1]=+new Date()-points[0];
        </script>            
    </head>
    <body class="zh_CN" mycollectionplug="bind">
        <div class="head" id="header">
            <div class="head_box">
                <div class="inner wrp">
                    <h1 class="logo">
                        <a href="./index_files/index.html" title="微信公众平台">微信公众平台</a>
                    </h1>
                    <div class="account">
                        <div class="account_meta account_faq">
                            第一次使用公众平台？                            <a href="https://mp.weixin.qq.com/cgi-bin/readtemplate?t=register/step1_tmpl&lang=zh_CN">立即注册</a><i class="account_line">|</i><a href="http://kf.qq.com/faq/120911VrYVrA1509086vyumm.html" target="_blank">使用帮助</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="banner">
                <div class="inner wrp">
                    ...
                    <div class="login_frame">
                        ...
                        <form class="login_form" id="loginForm">
                            ...
                            <div class="login_help_panel">
                                ...
                                <a class="login_forget_pwd" href="https://mp.weixin.qq.com/acct/resetpwd?action=send_email_page">无法登录？</a>
                            </div>
                    ...
                    <dl class="qrcode_panel">
                        <dt>
                            <img src="../images/mp_qrcode218877.gif">
                        </dt>
                        <dd>
                            扫描并关注<br>微信公众平台                        </dd>
                    </dl>
        ...
        <div id="body" class="body page_login">
            ...
            <dl class="notices_box">
                <dt>
                    <i class="icon_login speaker"></i>系统公告
                                ...
                                <dd>
                    <i>●</i>
                    <a class="notices_title" href="https://mp.weixin.qq.com/cgi-bin/announce?action=getannouncement&key=1468936180&version=12&lang=zh_CN" target="_blank">
                        公众平台图文分析新增视频数据分析                    </a>
                    <span class="label_new"></span>
                                ...
                                <dd>
                    <i>●</i>
                    <a class="notices_title" href="https://mp.weixin.qq.com/cgi-bin/announce?action=getannouncement&key=1467639271&version=1&lang=zh_CN" target="_blank">
                        微信JSSDK调用统计功能发布                    </a>
                    <span class="label_new"></span>
                </dd>
            ...
            <div class="mp_kind_mod">
                ...
                <div class="mp_kind_mod_bd group">
                    <a href="http://kf.qq.com/faq/120911VrYVrA130805byM32u.html" target="_blank" class="mp_kind_wrp">
                        <dl class="mp_kind">
                    ...
                    <ul class="mp_case_list" id="iconList">
                        <li class="mp_case_item jsIconItem" name="zshyh" data-index="0">
                            <span class="icon_wrapper">
                                <i class="icon_mp_case zshyh jsIcon on"></i>
                            </span>
...
<script type="text/javascript">
    ...
    window._points&&(window._points[2]=+new Date());
        ...
        <script type="text/javascript">
          points[2]=+new Date()-points[0];
          var aSource = ""; 
          var toUrl = ""; 
        </script>
        <script onerror="wx_loaderror(this)" type="text/javascript" src="./js/jquery-1.9.126d05a.js">
        </script>
        <script onerror="wx_loaderror(this)" type="text/javascript" src="./js/login_new2f12f7.js">
        </script>
        <script onerror="wx_loaderror(this)" type="text/javascript" src="./js/html5Report218877.js"></script>
